...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
		...
		<div class="form-group">
            <input type="text" class="form-control" name="specialization" placeholder="Specialization" required="true">
        </div>
		<div class="form-group">
            <input type="number" class="form-control" name="Age" placeholder="Enter your Age" required="true" maxlength="10" pattern="[0-9]+">
        </div>
        <div class="form-group">
